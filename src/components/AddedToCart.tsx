...
const AddedToCart = () => {
    ...
    return (
        <div  data-testid="add-to-basket-confirmation-modal" className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
            <div className="relative bg-white rounded-lg shadow-lg p-6 w-1/2 h-1/2 mx-4">
                ...
                <div className="flex flex-col justify-center items-center mt-20">
                    ...
                    <h4 className="text-lg text-center font-semibold">Added to Basket
                    </h4>
                </div>
            </div>
        </div>
